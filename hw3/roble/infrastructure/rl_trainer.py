...
class RL_Trainer(RL_Trainer):
    ...
    def run_training_loop(self, n_iter, collect_policy, eval_policy,
        ...
        for itr in range(n_iter):
            ...
            if isinstance(self._agent, DQNAgent) or isinstance(self._agent, DDPGAgent) or isinstance(self._agent, TD3Agent) or isinstance(self._agent, SACAgent):
...
#                    self.perform_ddpg_logging(itr, all_logs)
            ...
            elif ((self._log_video or self._log_metrics) and
                ( itr % print_period == 0) and len(all_logs) < 1):
                print("========== \n All logs empty, skipping logging... \n ==========")
    ...
    def train_agent(self):
        ...
        for train_step in range(self._params['alg']['num_agent_train_steps_per_iter']):
            ...
            if train_log is not None and len(train_log) > 0:
    ...
    def perform_dqn_logging(self, itr, all_logs):
        ...
        logs["Train_EnvstepsSoFar"] = self._agent.t
        print("Timestep %d" % (self._agent.t,))
    ...
    def perform_logging(self, itr, eval_policy, all_logs, **kwargs):
    ...
    def collect_training_trajectories(
        ...
        return super().collect_training_trajectories(itr + 1, load_initial_expertdata, collect_policy, batch_size, **kwargs)
